...
assert_contains "installers/windows/phases/07-devtools.ps1" 'foreach \(\$cmd in @\(Get-Command \$name' "Windows installer does not enumerate multiple python PATH commands"
assert_contains "installers/windows/phases/07-devtools.ps1" 'foreach \(\$pyLauncher in @\(Get-Command py' "Windows installer does not enumerate multiple py launcher commands"
...
assert_contains "installers/windows/ods.ps1" 'foreach \(\$cmd in @\(Get-Command \$name' "ods.ps1 agent start does not enumerate multiple python PATH commands"
assert_contains "installers/windows/ods.ps1" 'foreach \(\$pyLauncher in @\(Get-Command py' "ods.ps1 agent start does not enumerate multiple py launcher commands"
